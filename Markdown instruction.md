...
Для надстрочных символов используйте HTML, например:
Текст, далее в знакке <> указать sup и без пробела написать текст надстрочного символа, далее восклицательный знак без пробела!, далее в знаке <> указать /sup. Например:

Goodbye <sup>This is superscript!</sup>

### Подстрочные символы

Для поднадстрочных символов используйте HTML, например:
Текст, далее в знакке <> указать sub и без пробела написать текст надстрочного символа, далее восклицательный знак без пробела!, далее в знаке <> указать /sub. Например:
